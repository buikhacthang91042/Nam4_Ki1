...
<title>Đăng nhập đa ngôn ngữ</title>
</head>
<body>
	<c:set var = "languageCode" value="${param.radioLanguageCode}"></c:set>
	...
	<input type="radio" name="radioLanguageCode" value = "vi" 
	<c:if test=" ${languageCode == 'vi'}">checked</c:if>
	><fmt:message key ="vn"></fmt:message>
	
	<input type="radio" name="radioLanguageCode" value = "en" 
