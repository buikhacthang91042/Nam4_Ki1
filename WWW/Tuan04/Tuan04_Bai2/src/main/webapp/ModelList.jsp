...
<body>
	<p>
		<a href="/Tuan04_Bai2/ShoppingCart.jsp">Xem giỏ hàng</a>
	</p>
	<c:forEach items="${ds}" var="sp">
		<div class="a">
			<form name= "modelDetail" method="POST" action="/Tuan04_Bai2/CartController"
				>



				${sp.model} <br /> <img src="/Tuan04_Bai2${sp.imgURL}"
